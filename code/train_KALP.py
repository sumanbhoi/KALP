...
# Here pass the parameters for the dimension etc.
    ...
    model = KALP(voc_size, ehr_adj, ddi_adj, emb_dim=64, num_heads=2, num_layers=2, d_ff=256, max_seq_length=1000, dropout=0.1, device=device, ddi_in_memory=DDI_IN_MEM)
        ...
        for epoch in range(EPOCH):
            ...
            for step, input in enumerate(data_train):
                for idx, adm in enumerate(input):
                    ...
                    target_output, balanced_loss = model(seq_input)
